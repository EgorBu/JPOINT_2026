...
# TODO qr код с ссылкой на презентацию
...
# TODO - как вообще люди взаимодействуют с LLM? ide, cloud agent, chat

---

### Что такое кодовый агент? 
#### TODO - картинку нормальную сделать, 
#### хочется по больше про агентов: как работают - цикл работы - ллм бек -> тул -> выхлоп тулы в ллм -> ллм принимает следующее решение
...
#### TODO - что-то важное еще стоит подчеркнуть тут?
#### TODO - слайд можно продублируй в начало - добавить что ОБУЧАЕМ модели + giga ide/girverse/plugins/etc
...
#### TODO скринщшот - был код до и после изменения - тело функции заменили на заглушку
