...
* Кто использует ИИ для разработки
* Кто хочет узнать, как ИИ стал так хорош для разработки



<!--
также замечу, что QR вы сможете в конце отсканировать тоже на презентацию

внизу в правом углу каждой страницы есть нормер - если захотите в конце задать вопрос про конркетный слайд
-->
...
- **Риски**: 
   - агент, написавший и запустивший код == потенциальные проблемы.
- **Нужна изоляция**: 
   - каждая SWE задача == свой контейнер с окружением.
- **Автоматическая верификация**: 
  - автоматически проверяем тесты проходят или нет.
...
* автоверификация решения == масштабирование
...
<!--
агенты могут начать эксплойтить то, как их обмеряют - ИСТОРИЯ ПРО ОПУС И ТЕСТЫ
